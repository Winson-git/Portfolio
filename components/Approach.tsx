    ...
    <section className="w-full py-20">
        ...
        <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
            <Card 
                ...
                description="React, React Native, Next.Js"
            >
            <CanvasRevealEffect
                animationSpeed={5.1}
            ...
            <Card 
                ...
                description="JavaScript, TypeScript, Swift, PHP, CSS, HTML5, Python, Java, R"
            >
            <CanvasRevealEffect
                animationSpeed={3}
            ...
            <Card 
                ...
                icon={<AceternityIcon order="Standards"/>}
                description="ES6 Syntax, Component-Based Architecture, Functional Progamming, Linting, Formatting, Schema Design, Version Control, Error Handling, Testing"
            >
            <CanvasRevealEffect
                animationSpeed={3}
...
const AceternityIcon = ({ order }:{ order:string }) => {
  return (
    ...
    <button className="relative inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
        ...
        <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-slate-950 px-5 py-2 text-white backdrop-blur-3xl z-10 text-2xl font-bold">
            {order}
        </span>
    </button>
  );
